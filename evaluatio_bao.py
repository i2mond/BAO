...
def whole_eval(list, predict_dir, gt_dir, logfile, comment='comment', type='npy',
               t=None, curve=True, num_classes=91, start=0, end=60):
    if type == 'npy':
...
if __name__ == '__main__':
    ...
    parser.add_argument("--predict_dir", default='datas/out_crf/..', type=str)
    parser.add_argument("--gt_dir", default='VOCdevkit/VOC2012/SegmentationClass', type=str)
    parser.add_argument('--logfile', default='./evallog_new.txt',type=str)
